...
[OpenSpan.Design.ComponentIdentityAttribute("Automator-8DA237C12EAC963")]
[System.ComponentModel.ToolboxItemAttribute(false)]
public sealed class Shutdown : OpenSpan.Automation.Automator
{
	
	[OpenSpan.Design.ComponentIdentityAttribute("Automator-8DA237C12EAC963\\EntryPoint-8DA237C12EC75FD")]
	public OpenSpan.Automation.EntryPoint entryPoint1;
	
	[OpenSpan.Design.ComponentIdentityAttribute("Automator-8DA237C12EAC963\\HiddenTypeProxy-8DA237C13008C75")]
	...
	[OpenSpan.Design.ComponentIdentityAttribute("Automator-8DA237C12EAC963\\Pause-8DA237C13023902")]
	...
	public Shutdown()
	{
		...
		// 
		this.Id = new OpenSpan.Design.ComponentIdentity("Automator-8DA237C12EAC963");
		// 
		// Set component Ids
		// 
		this.SetId(this.entryPoint1, new OpenSpan.Design.ComponentIdentity("EntryPoint-8DA237C12EC75FD"));
		this.SetId(this.hiddenTypeProxy1, new OpenSpan.Design.ComponentIdentity("HiddenTypeProxy-8DA237C13008C75"));
		this.SetId(this.labelHost1, new OpenSpan.Design.ComponentIdentity("LabelHost-8DA237C12EE227A"));
		this.SetId(this.exitPoint1, new OpenSpan.Design.ComponentIdentity("ExitPoint-8DA237C12EFCF14"));
		this.SetId(this.tryHost1, new OpenSpan.Design.ComponentIdentity("TryHost-8DA237C12F17BD2"));
		this.SetId(this.catchHost1, new OpenSpan.Design.ComponentIdentity("CatchHost-8DA237C12F3281B"));
		this.SetId(this.pause1, new OpenSpan.Design.ComponentIdentity("Pause-8DA237C13023902"));
		this.SetId(this.labelHost2, new OpenSpan.Design.ComponentIdentity("LabelHost-8DA237C12F68132"));
		this.SetId(this.tryHost2, new OpenSpan.Design.ComponentIdentity("TryHost-8DA237C12F82DC7"));
		this.SetId(this.catchHost2, new OpenSpan.Design.ComponentIdentity("CatchHost-8DA237C12F9DA4A"));
		this.SetId(this.jumpHost2, new OpenSpan.Design.ComponentIdentity("JumpHost-8DA237C12FB86D6"));
		this.SetId(this.connectableMethod14, new OpenSpan.Design.ComponentIdentity("ConnectableMethod-8DA237C12FD336C"));
		this.SetId(this.connectableMethod15, new OpenSpan.Design.ComponentIdentity("ConnectableMethod-8DA237C12FEDFFF"));
		this.SetId(this.connectableProperties1, new OpenSpan.Design.ComponentIdentity("ConnectableProperties-8DA237C2102FBE7"));
		this.SetId(this.connectableMethod1, new OpenSpan.Design.ComponentIdentity("ConnectableMethod-8DA237C2777D884"));
		this.SetId(this.connectableProperties2, new OpenSpan.Design.ComponentIdentity("ConnectableProperties-8DA237C2B09950A"));
		this.SetId(this.connectableMethod2, new OpenSpan.Design.ComponentIdentity("ConnectableMethod-8DA237C30195756"));
		// 
		// Shutdown
		// 
		ComponentInfo.CodeDomData = _resources_.GetString("_Shutdown_1_");
		this.DocumentScale = 0.5457075F;
		...
		dynamicpropertyinfo3.CodeDomData = _resources_.GetString("_Shutdown_5_");
		...
		this.entryPoint1.InstanceUniqueId = new OpenSpan.Design.ComponentIdentity("Automator-8DA237C12EAC963\\EntryPoint-8DA237C12EC75FD");
		...
		dynamicmethodinfo2.CodeDomData = _resources_.GetString("_Shutdown_6_");
		...
		dynamicpropertyinfo4.CodeDomData = _resources_.GetString("_Shutdown_7_");
		...
		this.exitPoint1.InstanceUniqueId = new OpenSpan.Design.ComponentIdentity("Automator-8DA237C12EAC963\\EntryPoint-8DA237C12EC75FD");
		// 
		// tryHost1
		// 
		...
		this.tryHost1.InstanceUniqueId = new OpenSpan.Design.ComponentIdentity("Automator-8DA237C12EAC963\\TryHost-8DA237C12F17BD2");
		// 
		// catchHost1
		// 
		this.catchHost1.CaughtLinkIDs.Add(80);
		this.catchHost1.CaughtLinkIDs.Add(84);
		this.catchHost1.CaughtLinkIDs.Add(86);
		...
		dynamiceventinfo1.CodeDomData = _resources_.GetString("_Shutdown_8_");
		...
		dynamicpropertyinfo5.CodeDomData = _resources_.GetString("_Shutdown_9_");
		this.catchHost1.DynamicMembers.Add(dynamiceventinfo1);
		this.catchHost1.DynamicMembers.Add(dynamicpropertyinfo5);
		this.catchHost1.ExceptionsHandled = false;
		this.catchHost1.InstanceTypeName = "OpenSpan.Automation.CatchHost";
		this.catchHost1.InstanceUniqueId = new OpenSpan.Design.ComponentIdentity("Automator-8DA237C12EAC963\\CatchHost-8DA237C12F3281B");
		// 
		// pause1
		// 
		...
		dynamicmethodinfo3.CodeDomData = _resources_.GetString("_Shutdown_6_");
		...
		this.tryHost2.InstanceUniqueId = new OpenSpan.Design.ComponentIdentity("Automator-8DA237C12EAC963\\TryHost-8DA237C12F82DC7");
		// 
		// catchHost2
		// 
		...
		dynamiceventinfo2.CodeDomData = _resources_.GetString("_Shutdown_8_");
		...
		dynamicpropertyinfo6.CodeDomData = _resources_.GetString("_Shutdown_9_");
		this.catchHost2.DynamicMembers.Add(dynamiceventinfo2);
		this.catchHost2.DynamicMembers.Add(dynamicpropertyinfo6);
		this.catchHost2.ExceptionsHandled = false;
		this.catchHost2.InstanceTypeName = "OpenSpan.Automation.CatchHost";
		this.catchHost2.InstanceUniqueId = new OpenSpan.Design.ComponentIdentity("Automator-8DA237C12EAC963\\CatchHost-8DA237C12F9DA4A");
		// 
		// jumpHost2
		// 
		...
		this.jumpHost2.InstanceUniqueId = new OpenSpan.Design.ComponentIdentity("Automator-8DA237C12EAC963\\LabelHost-8DA237C12F68132");
		memberprototype1.DefaultValue = null;
		memberprototype1.MemberName = "GoToLabel";
		memberprototype1.MemberType = System.Reflection.MemberTypes.Method;
		memberprototype1.Signature.ReturnType = "System.Void";
		memberprototype1.TypeName = "System.Void";
		this.jumpHost2.MemberPrototypes.Add(memberprototype1);
		this.jumpHost2.ParamsLength = 0;
		this.jumpHost2.SerializedParamsDefaultValues = "";
		// 
		// connectableMethod14
		// 
		this.connectableMethod14.DisplayName = "<TerminateRuntime>";
		this.connectableMethod14.ExceptionsHandled = false;
		this.connectableMethod14.InstanceTypeName = "OpenSpan.Runtime.RuntimeHost";
		this.connectableMethod14.InstanceUniqueId = new OpenSpan.Design.ComponentIdentity("EMPTY");
		memberprototype2.DefaultValue = null;
		memberprototype2.MemberName = "TerminateRuntime";
		memberprototype2.MemberType = System.Reflection.MemberTypes.Method;
		memberprototype2.Signature.ReturnType = "System.Void";
		memberprototype2.TypeName = "System.Void";
		this.connectableMethod14.MemberPrototypes.Add(memberprototype2);
		this.connectableMethod14.ParamsLength = 0;
		this.connectableMethod14.SerializedParamsDefaultValues = "";
		// 
		// connectableMethod15
		// 
		this.connectableMethod15.DisplayName = "<TerminateRuntime>";
		this.connectableMethod15.ExceptionsHandled = false;
		this.connectableMethod15.InstanceTypeName = "OpenSpan.Runtime.RuntimeHost";
		this.connectableMethod15.InstanceUniqueId = new OpenSpan.Design.ComponentIdentity("EMPTY");
		memberprototype3.DefaultValue = null;
		memberprototype3.MemberName = "TerminateRuntime";
		memberprototype3.MemberType = System.Reflection.MemberTypes.Method;
		memberprototype3.Signature.ReturnType = "System.Void";
		memberprototype3.TypeName = "System.Void";
		this.connectableMethod15.MemberPrototypes.Add(memberprototype3);
		...
		this.connectableProperties1.InstanceTypeName = "OpenSpan.Adapters.Text.Host.WinHllapi.WinHllapiAdapter";
		this.connectableProperties1.InstanceUniqueId = new OpenSpan.Design.ComponentIdentity("WinHllapiAdapter-8DA22AC03529C72");
		memberprototype4.DefaultValue = null;
		memberprototype4.MemberName = "IsRunning";
		...
		this.connectableMethod1.InstanceTypeName = "OpenSpan.Adapters.Text.Host.WinHllapi.WinHllapiAdapter";
		this.connectableMethod1.InstanceUniqueId = new OpenSpan.Design.ComponentIdentity("WinHllapiAdapter-8DA22AC03529C72");
		...
		this.connectableProperties2.InstanceUniqueId = new OpenSpan.Design.ComponentIdentity("WindowsAdapter-8DA22ABDB522C1E");
		memberprototype6.DefaultValue = null;
		memberprototype6.MemberName = "IsRunning";
		...
		this.connectableMethod2.InstanceTypeName = "OpenSpan.Adapters.Windows.WindowsAdapter";
		this.connectableMethod2.InstanceUniqueId = new OpenSpan.Design.ComponentIdentity("WindowsAdapter-8DA22ABDB522C1E");
		memberprototype7.DefaultValue = null;
		memberprototype7.MemberName = "Stop";
		...
		// 
		this.CodeDomData = _resources_.GetString("_Shutdown_10_");
		// 
		// Add components
		// 
	...
	/// </summary>
	public void Execute(bool Shutdown)
	{
	...
	internal OpenSpan.Automation.EntryPoint Create_entryPoint1(out System.Collections.Generic.ICollection<System.ComponentModel.IComponent> components)
	{
		...
		this.SetId(entryPoint1, new OpenSpan.Design.ComponentIdentity("EntryPoint-8DA237C12EC75FD"));
		...
		// Set designComp Ids
		// 
		this.SetId(hiddenTypeProxy1, new OpenSpan.Design.ComponentIdentity("HiddenTypeProxy-8DA237C13008C75"));
		// 
		// Add components
		// 
	...
	internal OpenSpan.Automation.LabelHost Create_labelHost1(out System.Collections.Generic.ICollection<System.ComponentModel.IComponent> components)
	{
		...
		this.SetId(labelHost1, new OpenSpan.Design.ComponentIdentity("LabelHost-8DA237C12EE227A"));
		labelHost1.DisplayName = "Success";
		OpenSpan.DynamicMembers.DynamicMethodInfo dynamicmethodinfo1 = new OpenSpan.DynamicMembers.DynamicMethodInfo();
		dynamicmethodinfo1.Source = "";
		dynamicmethodinfo1.Visibility = OpenSpan.TypeManagement.MemberVisibilityLevel.AlwaysHidden;
		dynamicmethodinfo1.CodeDomData = _resources_.GetString("_Shutdown_6_");
	...
	internal OpenSpan.Automation.ExitPoint Create_exitPoint1(out System.Collections.Generic.ICollection<System.ComponentModel.IComponent> components)
	{
		...
		this.SetId(exitPoint1, new OpenSpan.Design.ComponentIdentity("ExitPoint-8DA237C12EFCF14"));
		...
		dynamicpropertyinfo1.CodeDomData = _resources_.GetString("_Shutdown_7_");
		...
		dynamicpropertyinfo2.ValidateConnectionCallback = null;
		dynamicpropertyinfo2.Visibility = OpenSpan.TypeManagement.MemberVisibilityLevel.AlwaysHidden;
		dynamicpropertyinfo2.CodeDomData = _resources_.GetString("_Shutdown_3_");
		...
		dynamicpropertyinfo4.CodeDomData = _resources_.GetString("_Shutdown_5_");
		entryPoint1.DynamicMembers.Add(dynamicpropertyinfo3);
		...
		exitPoint1.InstanceUniqueId = new OpenSpan.Design.ComponentIdentity("Automator-8DA237C12EAC963\\EntryPoint-8DA237C12EC75FD");
		// 
		// Set designComp Ids
		// 
		this.SetId(entryPoint1, new OpenSpan.Design.ComponentIdentity("EntryPoint-8DA237C12EC75FD"));
	...
	internal OpenSpan.Automation.Design.TryHost Create_tryHost1(out System.Collections.Generic.ICollection<System.ComponentModel.IComponent> components)
	{
		...
		this.SetId(tryHost1, new OpenSpan.Design.ComponentIdentity("TryHost-8DA237C12F17BD2"));
		tryHost1.DisplayName = "TRY";
		tryHost1.ExceptionsHandled = false;
		tryHost1.InstanceTypeName = "OpenSpan.Automation.Design.TryHost";
		tryHost1.InstanceUniqueId = new OpenSpan.Design.ComponentIdentity("Automator-8DA237C12EAC963\\TryHost-8DA237C12F17BD2");
		// 
		// Result
		// 
		return tryHost1;
	...
	internal OpenSpan.Automation.CatchHost Create_catchHost1(out System.Collections.Generic.ICollection<System.ComponentModel.IComponent> components)
	{
		...
		this.SetId(catchHost1, new OpenSpan.Design.ComponentIdentity("CatchHost-8DA237C12F3281B"));
		catchHost1.CaughtLinkIDs.Add(80);
		catchHost1.CaughtLinkIDs.Add(84);
		catchHost1.CaughtLinkIDs.Add(86);
		...
		dynamicpropertyinfo1.ValidateConnectionCallback = null;
		dynamicpropertyinfo1.Visibility = OpenSpan.TypeManagement.MemberVisibilityLevel.AlwaysHidden;
		dynamicpropertyinfo1.CodeDomData = _resources_.GetString("_Shutdown_9_");
		...
		catchHost1.InstanceUniqueId = new OpenSpan.Design.ComponentIdentity("Automator-8DA237C12EAC963\\CatchHost-8DA237C12F3281B");
		// 
		// Result
		// 
		return catchHost1;
	...
	internal OpenSpan.Controls.Pause Create_pause1(out System.Collections.Generic.ICollection<System.ComponentModel.IComponent> components)
	{
		...
		this.SetId(pause1, new OpenSpan.Design.ComponentIdentity("Pause-8DA237C13023902"));
	...
	internal OpenSpan.Automation.LabelHost Create_labelHost2(out System.Collections.Generic.ICollection<System.ComponentModel.IComponent> components)
	{
		...
		this.SetId(labelHost2, new OpenSpan.Design.ComponentIdentity("LabelHost-8DA237C12F68132"));
	...
	internal OpenSpan.Automation.Design.TryHost Create_tryHost2(out System.Collections.Generic.ICollection<System.ComponentModel.IComponent> components)
	{
		...
		this.SetId(tryHost2, new OpenSpan.Design.ComponentIdentity("TryHost-8DA237C12F82DC7"));
		tryHost2.DisplayName = "TRY";
		tryHost2.ExceptionsHandled = false;
		tryHost2.InstanceTypeName = "OpenSpan.Automation.Design.TryHost";
		tryHost2.InstanceUniqueId = new OpenSpan.Design.ComponentIdentity("Automator-8DA237C12EAC963\\TryHost-8DA237C12F82DC7");
		// 
		// Result
		// 
		return tryHost2;
	...
	internal OpenSpan.Automation.CatchHost Create_catchHost2(out System.Collections.Generic.ICollection<System.ComponentModel.IComponent> components)
	{
		...
		this.SetId(catchHost2, new OpenSpan.Design.ComponentIdentity("CatchHost-8DA237C12F9DA4A"));
		...
		catchHost2.InstanceUniqueId = new OpenSpan.Design.ComponentIdentity("Automator-8DA237C12EAC963\\CatchHost-8DA237C12F9DA4A");
		// 
		// Result
		// 
		return catchHost2;
	...
	internal OpenSpan.Automation.JumpHost Create_jumpHost2(out System.Collections.Generic.ICollection<System.ComponentModel.IComponent> components)
	{
		...
		this.SetId(jumpHost2, new OpenSpan.Design.ComponentIdentity("JumpHost-8DA237C12FB86D6"));
		jumpHost2.DisplayName = "<GoToLabel>";
		jumpHost2.ExceptionsHandled = false;
		jumpHost2.InstanceTypeName = "OpenSpan.Automation.LabelHost";
		jumpHost2.InstanceUniqueId = new OpenSpan.Design.ComponentIdentity("Automator-8DA237C12EAC963\\LabelHost-8DA237C12F68132");
		OpenSpan.Automation.MemberPrototype memberprototype1 = new OpenSpan.Automation.MemberPrototype();
		memberprototype1.DefaultValue = null;
		memberprototype1.MemberName = "GoToLabel";
		memberprototype1.MemberType = System.Reflection.MemberTypes.Method;
	...
	internal OpenSpan.Automation.ConnectableMethod Create_connectableMethod14(out System.Collections.Generic.ICollection<System.ComponentModel.IComponent> components)
	{
		...
		this.SetId(connectableMethod14, new OpenSpan.Design.ComponentIdentity("ConnectableMethod-8DA237C12FD336C"));
		connectableMethod14.DisplayName = "<TerminateRuntime>";
		connectableMethod14.ExceptionsHandled = false;
		connectableMethod14.InstanceTypeName = "OpenSpan.Runtime.RuntimeHost";
		connectableMethod14.InstanceUniqueId = new OpenSpan.Design.ComponentIdentity("EMPTY");
		OpenSpan.Automation.MemberPrototype memberprototype1 = new OpenSpan.Automation.MemberPrototype();
		memberprototype1.DefaultValue = null;
	...
	internal OpenSpan.Automation.ConnectableMethod Create_connectableMethod15(out System.Collections.Generic.ICollection<System.ComponentModel.IComponent> components)
	{
		...
		this.SetId(connectableMethod15, new OpenSpan.Design.ComponentIdentity("ConnectableMethod-8DA237C12FEDFFF"));
		connectableMethod15.DisplayName = "<TerminateRuntime>";
		connectableMethod15.ExceptionsHandled = false;
		connectableMethod15.InstanceTypeName = "OpenSpan.Runtime.RuntimeHost";
		connectableMethod15.InstanceUniqueId = new OpenSpan.Design.ComponentIdentity("EMPTY");
		OpenSpan.Automation.MemberPrototype memberprototype1 = new OpenSpan.Automation.MemberPrototype();
		memberprototype1.DefaultValue = null;
		memberprototype1.MemberName = "TerminateRuntime";
		memberprototype1.MemberType = System.Reflection.MemberTypes.Method;
	...
	internal OpenSpan.Automation.ConnectableProperties Create_connectableProperties1(out System.Collections.Generic.ICollection<System.ComponentModel.IComponent> components)
	{
		...
		this.SetId(connectableProperties1, new OpenSpan.Design.ComponentIdentity("ConnectableProperties-8DA237C2102FBE7"));
		connectableProperties1.DefaultValues = "";
		connectableProperties1.DisplayName = "Properties";
		connectableProperties1.ExceptionsHandled = false;
		connectableProperties1.InstanceTypeName = "OpenSpan.Adapters.Text.Host.WinHllapi.WinHllapiAdapter";
		connectableProperties1.InstanceUniqueId = new OpenSpan.Design.ComponentIdentity("WinHllapiAdapter-8DA22AC03529C72");
		OpenSpan.Automation.MemberPrototype memberprototype1 = new OpenSpan.Automation.MemberPrototype();
		memberprototype1.DefaultValue = null;
	...
	internal OpenSpan.Automation.ConnectableMethod Create_connectableMethod1(out System.Collections.Generic.ICollection<System.ComponentModel.IComponent> components)
	{
		...
		this.SetId(connectableMethod1, new OpenSpan.Design.ComponentIdentity("ConnectableMethod-8DA237C2777D884"));
		connectableMethod1.DisplayName = "<Stop>";
		connectableMethod1.ExceptionsHandled = false;
		connectableMethod1.InstanceTypeName = "OpenSpan.Adapters.Text.Host.WinHllapi.WinHllapiAdapter";
		connectableMethod1.InstanceUniqueId = new OpenSpan.Design.ComponentIdentity("WinHllapiAdapter-8DA22AC03529C72");
		OpenSpan.Automation.MemberPrototype memberprototype1 = new OpenSpan.Automation.MemberPrototype();
		memberprototype1.DefaultValue = null;
	...
	internal OpenSpan.Automation.ConnectableProperties Create_connectableProperties2(out System.Collections.Generic.ICollection<System.ComponentModel.IComponent> components)
	{
		...
		this.SetId(connectableProperties2, new OpenSpan.Design.ComponentIdentity("ConnectableProperties-8DA237C2B09950A"));
		...
		connectableProperties2.InstanceUniqueId = new OpenSpan.Design.ComponentIdentity("WindowsAdapter-8DA22ABDB522C1E");
		OpenSpan.Automation.MemberPrototype memberprototype1 = new OpenSpan.Automation.MemberPrototype();
		memberprototype1.DefaultValue = null;
		memberprototype1.MemberName = "IsRunning";
		memberprototype1.MemberType = System.Reflection.MemberTypes.Property;
	...
	internal OpenSpan.Automation.ConnectableMethod Create_connectableMethod2(out System.Collections.Generic.ICollection<System.ComponentModel.IComponent> components)
	{
		...
		this.SetId(connectableMethod2, new OpenSpan.Design.ComponentIdentity("ConnectableMethod-8DA237C30195756"));
		connectableMethod2.DisplayName = "<Stop>";
		connectableMethod2.ExceptionsHandled = false;
		connectableMethod2.InstanceTypeName = "OpenSpan.Adapters.Windows.WindowsAdapter";
		connectableMethod2.InstanceUniqueId = new OpenSpan.Design.ComponentIdentity("WindowsAdapter-8DA22ABDB522C1E");
		OpenSpan.Automation.MemberPrototype memberprototype1 = new OpenSpan.Automation.MemberPrototype();
		memberprototype1.DefaultValue = null;
		memberprototype1.MemberName = "Stop";
		memberprototype1.MemberType = System.Reflection.MemberTypes.Method;
